...
const projects = {
  0: { 
    ...
    ourSolutions: [
      <ul><li>Users can select their dietary restrictions and preferences to customize their content feed, improving the relevancy of meal ideas and recipes.</li></ul>,
      <ul><li>Enable creators to post meal ideas with specified ingredients, dietary alternatives, and restrictions, enriching the variety and quality of content.</li></ul>,
      <ul><li>A Pinterest-style feed showcasing meals, recipes, and dining options tailored to the user's dietary needs and preferences.</li></ul>,
      <ul><li>Barcode Scanner to scan ingredients in groceries or menu items, providing instant information on potential allergens or dietary restrictions.</li></ul>,
      <ul><li>A feature to find nearby restaurants with filters for dietary needs (vegan, gluten-free, halal, etc.), open status, ratings, prices, and specific cuisines, similar to Uber Eats.</li></ul>,
      <ul><li> Like Instagram, users can upload images of meals, tag ingredients, dietary restrictions, locations, and other creators or establishments, enhancing content sharing and discovery.</li></ul>
    ],
    ...
    userInterviews: [
       <ul><li>Diverse Dietary Restrictions: Participants have various dietary restrictions, including religious (Halal), lactose intolerance, and veganism. This diversity underscores the need for a flexible and inclusive approach in the digital solution.</li></ul>,
       <ul><li>Eating Habits and Preferences: Daily meals and preferences vary significantly, reflecting personal tastes, cultural backgrounds, and dietary restrictions. The solution must offer personalized options.</li></ul>,
       <ul><li>Challenges with Dining Out: Finding restaurants that cater to specific dietary needs is a common challenge, often requiring extensive questioning about menu options and ingredients, leading to discomfort.</li></ul>,
       <ul><li>Cooking and Meal Prep: Cooking at home is preferred due to control over ingredients, though it comes with its own set of challenges, including meal planning and finding suitable recipes.</li></ul>,
       <ul><li>Grocery Shopping: Identifying products that meet dietary needs can be tedious. There's a desire for an easier way to find and select suitable groceries.</li></ul>,
       <ul><li>Social and Emotional Impact: Dietary restrictions impact social interactions and emotional well-being, with experiences of isolation, inconvenience, and even bullying.</li></ul>,
       <ul><li>Digital Tools and Wish List: There's a gap in the market for comprehensive apps that cater to various dietary restrictions. Desired features include restaurant finders, recipe suggestions, ingredient substitutes, and social platforms.</li></ul>
    ],
    research: [
      <ul><li> Food allergies, involving the immune system, are currently incurable, necessitating complete avoidance of allergens to prevent life-threatening reactions.</li></ul>,
       <ul><li>Anaphylaxis: A severe, rapid onset allergic reaction that can be fatal, highlighting the importance of carrying epinephrine auto-injectors.</li></ul>,
       <ul><li>Allergic reactions can manifest in various ways (skin, respiratory, gastrointestinal, cardiovascular) and may occur minutes to hours post-exposure.</li></ul>,
       <ul><li>Canada's Priority Allergens: Include peanuts, tree nuts, sesame, milk, eggs, fish, crustaceans, molluscs, soy, wheat, triticale, and mustard.</li></ul>,
       <ul><li>Dietary restrictions stem from religious practices, health issues (e.g., allergies, celiac disease), and ethical considerations (e.g., veganism).</li></ul>,
       <ul><li>Can also stem from health improvements, ethical beliefs, and religious or cultural practices drive adherence despite challenges.</li></ul>
    ],
    ...
    competition: [
      <ul><li>Fig - Food scanner</li></ul>,
      <ul><li>Sift - Bad UI and just a food scanner</li></ul>,
      <ul><li>Chef's Plate - Subscription and recipe delivery focused</li></ul>,
    ],
    ...
    feedback: [
      <ul><li>"The QR code thing is smart. It helps me know about allergies or food restrictions when I'm out, making it easier to eat safely.”</li></ul>,
      <ul><li>“This would help with wayfinding recipes and also building a community with people that have similar restrictions and allergies. I would definitely use it to see what people are saying about restaurants that I’ve been wanting to try.”</li></ul>,
      <ul><li>“As someone who doesn’t know many cuisines, I think I would get confused with what the meal is just based on the picture.”</li></ul>
    ],
